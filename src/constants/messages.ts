...
export const ERROR_MESSAGES = {
  ...
  // Auth
  LOGIN_FAILED:
    "Bejelentkezés sikertelen. Ellenőrizd az email címet és a jelszót.",
  ...
  SEARCH_NOT_SUPPORTED:
    "Keresés ebben a kategóriában nem támogatott ID alapján.",
  INACTIVE_USER_DELETE:
    "Inaktív felhasználók végleges törlése funkció még nincs implementálva.",
...
export const SUCCESS_MESSAGES = {
  ...
  APPLICATION_SUBMITTED:
    "Sikeres jelentkezés! Hamarosan értesítünk a válaszról.",
