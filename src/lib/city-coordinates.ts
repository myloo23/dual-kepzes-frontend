...
export const hungarianCities: Record<string, { lat: number; lng: number }> = {
    ...
    "Zalaegerszeg": { lat: 46.8400, lng: 16.8444 },
    "Sopron": { lat: 47.6850, lng: 16.5839 },
    "Eger": { lat: 47.9026, lng: 20.3770 },
    "Nagykanizsa": { lat: 46.4530, lng: 16.9908 },
    "Dunaújváros": { lat: 46.9619, lng: 18.9350 },
    ...
    "Gyula": { lat: 46.6500, lng: 21.2833 },
    "Vác": { lat: 47.7758, lng: 19.1347 },
    "Pápa": { lat: 47.3300, lng: 17.4667 },
    "Hajdúböszörmény": { lat: 47.6694, lng: 21.5119 },
    "Keszthely": { lat: 46.7683, lng: 17.2500 },
    "Orosháza": { lat: 46.5667, lng: 20.6667 },
    "Tiszakécske": { lat: 46.9333, lng: 20.1000 },
    "Mosonmagyaróvár": { lat: 47.8681, lng: 17.2708 },
    "Kiskunfélegyháza": { lat: 46.7167, lng: 19.8500 },
    "Komló": { lat: 46.1900, lng: 18.2556 },
    "Siófok": { lat: 46.9050, lng: 18.0556 },
    "Kazincbarcika": { lat: 48.2500, lng: 20.6333 },
    "Szentes": { lat: 46.6500, lng: 20.2667 },
