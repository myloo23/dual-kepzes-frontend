    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm text-center">
        ...
        <p className="text-slate-600 mb-6 max-w-md mx-auto">
          ...
          a hallgatók nyomon követéséhez és a partnerkapcsolatok kezeléséhez.
        </p>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <h3 className="font-semibold text-slate-900 mb-1">Hallgatók kezelése</h3>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <div className="text-2xl mb-2">🏢</div>
          <h3 className="font-semibold text-slate-900 mb-1">Partnerkapcsolatok</h3>
          <p className="text-sm text-slate-600">
