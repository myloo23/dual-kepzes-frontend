...
interface PositionsListProps {
    positions: Position[];
    onCompanyClick: (companyData: { id?: string | number; name?: string; logoUrl?: string | null } | undefined) => void;
    onApply: (positionId: string | number) => void;
}

export default function PositionsList({ positions, onCompanyClick, onApply }: PositionsListProps) {
