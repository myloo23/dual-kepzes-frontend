...
export default function CompanyInfoModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Cég információk" size="2xl">
        ...
        {!hasFullData && (
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            <p className="text-sm text-amber-800">
              <strong>Megjegyzés:</strong> A cég részletes adatai jelenleg nem
              érhetők el. További információkért kérjük, vegye fel a kapcsolatot
              az álláshirdetésben megadott elérhetőségeken.
            </p>
          </div>
        )}
