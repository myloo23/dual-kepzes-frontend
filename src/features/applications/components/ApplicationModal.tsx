...
interface ApplicationModalProps {
    ...
    onSubmit: (note: string, cvFile?: File, motivationLetterFile?: File) => Promise<void>;
}
        ...
        >
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            {!cvFile ? (
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium">Önéletrajz feltöltése</span>
                                ...
                                <div className="relative flex items-center gap-3 rounded-xl border border-blue-100 bg-blue-50 p-3">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="truncate text-sm font-medium text-blue-900">{cvFile.name}</p>
                                        <p className="text-xs text-blue-700">{(cvFile.size / 1024 / 1024).toFixed(2)} MB</p>
                                    </div>
                                    <button 
                                        onClick={() => {
                                            setCvFile(null);
                        ...
                        <div className="space-y-2">
                             <label className="text-sm font-medium text-slate-700 block">
                                Motivációs levél <span className="text-slate-400 font-normal">(opcionális)</span>
                            </label>
                            <input
                                type="file"
                            ...
                            {!motivationFile ? (
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium">Motivációs levél feltöltése</span>
                                    <span className="text-xs text-slate-400">PDF, DOCX (max 5MB)</span>
                                </button>
                            ) : (
                                <div className="relative flex items-center gap-3 rounded-xl border border-blue-100 bg-blue-50 p-3">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="truncate text-sm font-medium text-blue-900">{motivationFile.name}</p>
                                        <p className="text-xs text-blue-700">{(motivationFile.size / 1024 / 1024).toFixed(2)} MB</p>
                                    </div>
                                    <button 
                                        onClick={() => {
                                            setMotivationFile(null);
