...
export default function StudentPartnershipsList({ partnerships, isLoading }: StudentPartnershipsListProps) {
    if (isLoading) {
    ...
    if (partnerships.length === 0) {
        return (
            <div className="rounded-lg border-2 border-dashed border-slate-200 p-12 text-center">
                <h3 className="mt-2 text-sm font-semibold text-gray-900">Nincsenek partnerkapcsolatok</h3>
                <p className="mt-1 text-sm text-gray-500">Még nincs aktív partnerkapcsolatod.</p>
            </div>
        );
    }
