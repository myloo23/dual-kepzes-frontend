...
export default function MentorPartnershipsList({ partnerships, isLoading }: MentorPartnershipsListProps) {
    if (isLoading) {
    ...
    if (partnerships.length === 0) {
        return (
            <div className="rounded-lg border-2 border-dashed border-slate-200 p-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Önhöz még nincs hozzárendelve hallgató.</p>
            </div>
        );
    }
