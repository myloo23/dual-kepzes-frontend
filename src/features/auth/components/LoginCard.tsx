...
export default function LoginCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-200 px-6 py-7">
      <h2 className="text-xl font-semibold mb-1 text-slate-900">Belépés</h2>
      ...
      <form onSubmit={onSubmit} className="space-y-3 text-sm">
        ...
        <div className="space-y-1">
          <label className="font-medium text-slate-700">E-mail cím</label>
          <input
            type="email"
      ...
      <div className="mt-4 flex items-center justify-between text-xs text-slate-500">
        <Link
          to="/forgot-password"
          className="text-sm text-dkk-blue hover:underline"
        >
          Elfelejtett jelszó?
        </Link>
